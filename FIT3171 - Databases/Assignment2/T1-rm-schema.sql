...
ALTER TABLE competitor
     ADD CONSTRAINT check_competitor_gender CHECK ( comp_gender IN ( 'M', 'F', 'U' ) );

ALTER TABLE competitor
     ADD CONSTRAINT check_competitor_unistatus CHECK ( comp_unistatus IN ( 'Y', 'N' ) );

ALTER TABLE competitor
     ADD CONSTRAINT check_competitor_ec_relationship CHECK ( comp_ec_relationship IN ( 'P', 'G', 'T', 'F' ) );
-- EMERCONTACT
...
ALTER TABLE team
     ADD CONSTRAINT entry_team_fk FOREIGN KEY ( event_id,entry_no)
